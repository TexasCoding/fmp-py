...
def mock_response_daily():
    return {
        "historical": [
            ...
            {"date": "2023-01-02", "open": 106, "high": 115, "low": 105, "close": 110, "volume": 1500},
        ]
    }
...
def mock_response_intraday():
    return [
        {"date": "2023-01-01 09:30:00", "open": 100, "high": 110, "low": 90, "close": 105, "volume": 1000},
        {"date": "2023-01-01 09:31:00", "open": 106, "high": 115, "low": 105, "close": 110, "volume": 1500},
    ]

def test_fmp_historical_data_initialization():
    fmp = FmpHistoricalData()
    assert hasattr(fmp, 'api_key'), "FmpHistoricalData class should have an attribute 'api_key'"
